...
class InternalToolsTabBarExpressions {
  ...
  public static class LocationGroupMenuItemExpressionsImpl extends ServerToolsTabMenuItemExpressionsImpl {
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 58, column 37
    function action_40 () : void {
      pcf.LoadHistoryInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 61, column 41
    function action_42 () : void {
      pcf.LoadIntegrityChecks.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 64, column 36
    function action_44 () : void {
      pcf.LoadErrorsInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 67, column 44
    function action_46 () : void {
      pcf.RuntimeEnvironmentInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 70, column 45
    function action_48 () : void {
      pcf.SafePersistingOrderInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 73, column 39
    function action_50 () : void {
      pcf.LoadedGosuClasses.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 75, column 39
