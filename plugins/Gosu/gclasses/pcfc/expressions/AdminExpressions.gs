...
class AdminExpressions {
  ...
  public static class AdminExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'location' attribute on LocationGroup (id=Admin) at Admin.pcf: line 23, column 42
    function action_34 () : void {
      pcf.IntegrationPluginsLG.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at Admin.pcf: line 25, column 42
    function action_50 () : void {
      pcf.IntegrationMessageLG.go()
    }
    ...
    static function canVisit_52 () : java.lang.Boolean {
      return perm.User.view
    }
    
    // LocationGroup (id=Admin) at Admin.pcf: line 12, column 67
    static function firstVisitableChildDestinationMethod_60 () : pcf.api.Destination {
      ...
      dest = pcf.IntegrationPluginsLG.createDestination()
      if (dest.canVisitSelf()) {
        return dest
      }
      dest = pcf.IntegrationMessageLG.createDestination()
      if (dest.canVisitSelf()) {
        return dest
      }
      return null
    ...
    function menuActions_onEnter_53 (def :  pcf.AdminMenuActions) : void {
      def.onEnter()
    }
    
    // 'menuActions' attribute on LocationGroup (id=Admin) at Admin.pcf: line 12, column 67
    function menuActions_refreshVariables_54 (def :  pcf.AdminMenuActions) : void {
      def.refreshVariables()
    }
    
    // 'menuTree' attribute on LocationGroup (id=Admin) at Admin.pcf: line 12, column 67
    function menuTree_onEnter_55 (def :  pcf.AdminMenuTree) : void {
      def.onEnter()
    }
    
    // 'menuTree' attribute on LocationGroup (id=Admin) at Admin.pcf: line 12, column 67
    function menuTree_refreshVariables_56 (def :  pcf.AdminMenuTree) : void {
      def.refreshVariables()
    }
    ...
    function tabBar_onEnter_58 (def :  pcf.TabBar) : void {
      def.onEnter()
    }
    
    // 'tabBar' attribute on LocationGroup (id=Admin) at Admin.pcf: line 12, column 67
    function tabBar_refreshVariables_59 (def :  pcf.TabBar) : void {
      def.refreshVariables()
    }
  ...
  public static class LocationGroupMenuItem5ExpressionsImpl extends AdminExpressionsImpl {
    ...
    // 'location' attribute on LocationGroup (id=Admin) at IntegrationPluginsLG.pcf: line 9, column 57
  ...
  @javax.annotation.Generated("config/web/pcf/admin/Admin.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LocationGroupMenuItem6ExpressionsImpl extends AdminExpressionsImpl {
    public construct(widget :  Object) {
      super(widget, 1)
    }
    ...
    // 'location' attribute on LocationGroup (id=Admin) at IntegrationMessageLG.pcf: line 11, column 49
    function action_36 () : void {
      pcf.IntegrationMessageTablePage.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at IntegrationMessageLG.pcf: line 13, column 56
    function action_38 () : void {
      pcf.IntegrationMessageHistoryTablePage.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at IntegrationMessageLG.pcf: line 15, column 53
    function action_40 () : void {
      pcf.IntegrationMessageGeneratorPage.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at IntegrationMessageLG.pcf: line 17, column 53
    function action_42 () : void {
      pcf.IntegrationMessageExceptionPage.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at IntegrationMessageLG.pcf: line 19, column 56
    function action_44 () : void {
      pcf.IntegrationMessageSafeOrderingPage.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at IntegrationMessageLG.pcf: line 21, column 59
    function action_46 () : void {
      pcf.IntegrationMessageAcknowledgementPage.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at IntegrationMessageLG.pcf: line 23, column 49
