...
class ServerToolsExpressions {
  ...
  public static class LocationGroupMenuItemExpressionsImpl extends ServerToolsExpressionsImpl {
    ...
    // 'location' attribute on LocationGroup (id=ServerTools) at InfoPages.pcf: line 58, column 37
    function action_40 () : void {
      pcf.LoadHistoryInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=ServerTools) at InfoPages.pcf: line 61, column 41
    function action_42 () : void {
      pcf.LoadIntegrityChecks.go()
    }
    
    // 'location' attribute on LocationGroup (id=ServerTools) at InfoPages.pcf: line 64, column 36
    function action_44 () : void {
      pcf.LoadErrorsInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=ServerTools) at InfoPages.pcf: line 67, column 44
    function action_46 () : void {
      pcf.RuntimeEnvironmentInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=ServerTools) at InfoPages.pcf: line 70, column 45
    function action_48 () : void {
      pcf.SafePersistingOrderInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=ServerTools) at InfoPages.pcf: line 73, column 39
    function action_50 () : void {
      pcf.LoadedGosuClasses.go()
    }
    
    // 'location' attribute on LocationGroup (id=ServerTools) at InfoPages.pcf: line 75, column 39
  ...
  public static class ServerToolsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_106 () : java.lang.Boolean {
      return perm.User.ServerTools or perm.User.DevAllAccess
    }
    
    // LocationGroup (id=ServerTools) at ServerTools.pcf: line 10, column 18
    static function firstVisitableChildDestinationMethod_112 () : pcf.api.Destination {
    ...
    function menuActions_onEnter_107 (def :  pcf.InternalToolsMenuActions) : void {
      def.onEnter()
    }
    
    // 'menuActions' attribute on LocationGroup (id=ServerTools) at ServerTools.pcf: line 10, column 18
    function menuActions_refreshVariables_108 (def :  pcf.InternalToolsMenuActions) : void {
      def.refreshVariables()
    }
    
    // 'tabBar' attribute on LocationGroup (id=ServerTools) at ServerTools.pcf: line 10, column 18
    function tabBar_onEnter_109 (def :  pcf.InternalToolsTabBar) : void {
      def.onEnter()
    }
    
    // 'tabBar' attribute on LocationGroup (id=ServerTools) at ServerTools.pcf: line 10, column 18
    function tabBar_refreshVariables_110 (def :  pcf.InternalToolsTabBar) : void {
      def.refreshVariables()
    }
    
    // 'title' attribute on LocationGroup (id=ServerTools) at ServerTools.pcf: line 10, column 18
    static function title_111 () : java.lang.Object {
      return null
    }
